...
def main():
    ...
    try:
        #retirando os possiveis espaços extras
        ...
        # **Adicionar este trecho para verificar células em branco**
        # Checando por células em branco em colunas específicas
        ...
        messagebox.showerror("Erro", "Erro ao gerar o arquivo. Verifique se os valores da planilha seguem o padrão recomendado.")
